    ...
    public void registerProperties()
    {
        ...
        this.add(ModEntities.GO_KART.get(), VehicleProperties.builder()
                ...
                .addWheel(Wheel.builder()
                        ...
                        .setAutoScale(true)
                        .setParticles(true))
                .addSeat(Seat.of(0.0, -3.0, -1.0, true))
                .setCanChangeWheels(true)
                .setCanBePainted(true)
                .setCamera(CameraProperties.builder()
                        .setPosition(0, 1, 0))
        ...
        this.add(ModEntities.MINI_BUS.get(), VehicleProperties.builder()
                ...
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.ROOF_FRAME)
                        .setOffset(0, 13, 0)
                        .addModelLocation(VehicleModels.MINI_BUS_COSMETIC_STOCK_ROOF.getModelLocation())
                        .addModelLocation(VehicleModels.MINI_BUS_COSMETIC_FRONT_ROOF.getModelLocation(),
                                StandardCosmetics.REAR,
                                StandardCosmetics.ROOF))
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.ROOF)
                        .setOffset(0, 22, 0)
                        .addModelLocation(VehicleModels.MINI_BUS_COSMETIC_ROOF_RACKS.getModelLocation()))
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.LEFT_DOOR)
                        .setOffset(11.5, 5, 20.5)
                        .addModelLocation(VehicleModels.MINI_BUS_COSMETIC_STOCK_LEFT_DOOR.getModelLocation())
                ...
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.RIGHT_DOOR)
                        .setOffset(-11.5, 5, 20.5)
                        .addModelLocation(VehicleModels.MINI_BUS_COSMETIC_STOCK_RIGHT_DOOR.getModelLocation())
                        .addAction(new OpenableAction(Axis.Y, 75F, new ResourceLocation("vehicle:entity.vehicle.door.open"), new ResourceLocation("vehicle:entity.vehicle.door.close"), 12)))
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.LEFT_SLIDING_DOOR)
                        .setOffset(11.5, 5, -7.5)
                        .addModelLocation(VehicleModels.MINI_BUS_COSMETIC_STOCK_SLIDING_DOOR.getModelLocation())
                ...
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.REAR)
                        .setOffset(0, 6, -22.0)
                        .addModelLocation(VehicleModels.MINI_BUS_COSMETIC_AIRCON_LADDER_REAR_DECOR.getModelLocation()))
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.SEAT)
                        .setOffset(0, 5, 0)
                        .addModelLocation(VehicleModels.MINI_BUS_COSMETIC_STOCK_SEAT.getModelLocation()))
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.DASHBOARD)
                        .setOffset(0, 5, 16)
                        .addModelLocation(VehicleModels.MINI_BUS_COSMETIC_STOCK_DASHBOARD.getModelLocation()))
        );
        ...
        this.add(ModEntities.MOPED.get(), VehicleProperties.builder()
                ...
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.SEAT)
                        .setOffset(0, 7, -6.5)
                        .addModelLocation(VehicleModels.MOPED_COSMETIC_STOCK_SEAT.getModelLocation()))
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.TRAY)
                        .setOffset(0, 7, -6.5)
                        .addModelLocation(VehicleModels.MOPED_COSMETIC_STOCK_TRAY.getModelLocation()))
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.FRONT_LIGHTS)
                        .setOffset(0, 10, 10.1719)
                        .addModelLocation(VehicleModels.MOPED_COSMETIC_STOCK_FRONT_LIGHT.getModelLocation()))
        );
        ...
        this.add(ModEntities.SPORTS_CAR.get(), VehicleProperties.builder()
                ...
                .addWheel(Wheel.builder()
                        .setPosition(Wheel.Position.FRONT)
                        .setSide(Wheel.Side.LEFT)
                        .setOffset(12.0, 3.0, 20.0)
                        .setScale(1.0, 1.4, 1.4))
                .addWheel(Wheel.builder()
                        .setPosition(Wheel.Position.FRONT)
                        .setSide(Wheel.Side.RIGHT)
                        .setOffset(12.0, 3.0, 20.0)
                ...
                .addWheel(Wheel.builder()
                        ...
                        .setScale(1.0, 1.4, 1.4)
                        .setParticles(true))
                .addSeat(Seat.of(7, -2, -5, true))
                .addSeat(Seat.of(-7, -2, -5))
                .setCamera(CameraProperties.builder()
                        .setDistance(5.0))
                .addExtended(PoweredProperties.builder()
                        .setEngineType(EngineType.LARGE_MOTOR)
                        ...
                        .setIgnitionTransform(Transform.create(-5.0, 4.5, 6.5, -45.0, 0.0, 0.0, 0.5))
                        .setFrontAxleOffset(20.0)
                        .setRearAxleOffset(-19.0)
                        .setEnergyCapacity(20000F)
                        ...
                        .setRenderEngine(true)
                        .setEngineTransform(Transform.create(0.0, 3.01, 19.0, 0.825))
                        .build())
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.HOOD)
                        .addModelLocation(VehicleModels.SPORTS_CAR_COSMETIC_HOOD.getModelLocation())
                ...
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.LEFT_DOOR)
                        .addModelLocation(VehicleModels.SPORTS_CAR_COSMETIC_LEFT_DOOR.getModelLocation())
                        .setOffset(15.0, 1.0, 10.0)
                        .addAction(new OpenableAction(Axis.Y, -75F, new ResourceLocation("vehicle:entity.vehicle.door.open"), new ResourceLocation("vehicle:entity.vehicle.door.close"), 12)))
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.RIGHT_DOOR)
                        .addModelLocation(VehicleModels.SPORTS_CAR_COSMETIC_RIGHT_DOOR.getModelLocation())
                        .setOffset(-15.0, 1.0, 10.0)
                ...
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.SPOILER)
                        .addModelLocation(VehicleModels.SPORTS_CAR_COSMETIC_BOOT.getModelLocation())
                ...
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.SEAT)
                        .addModelLocation(VehicleModels.SPORTS_CAR_COSMETIC_SEAT.getModelLocation())
                        .setOffset(0, 1.0, 0))
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.DASHBOARD)
                        .addModelLocation(VehicleModels.SPORTS_CAR_COSMETIC_DASHBOARD.getModelLocation())
                        .setOffset(0, 14.0, 12.0))
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.ROOF)
                        .addModelLocation(VehicleModels.SPORTS_CAR_COSMETIC_ROOF.getModelLocation())
                        .setOffset(0, 14.0, 0)));
        ...
        this.add(ModEntities.SPORTS_PLANE.get(), VehicleProperties.builder()
                ...
                .addWheel(Wheel.builder()
                        .setPosition(Wheel.Position.FRONT)
                        .setOffset(0.0, -0.9021, 26.8272)
                        .setScale(1.0, 0.0, 0.0)
                        .setAutoScale(true))
                .addWheel(Wheel.builder()
                        .setOffset(15.5, 0.0, -5.5))
                .addWheel(Wheel.builder()
                        .setOffset(-15.5, 0.0, -5.5))
                .setCanBePainted(true)
                .setCanFitInTrailer(false)
                ...
                .addExtended(PlaneProperties.builder()
                        ...
                        .setMaxTurnAngle(2F)
                        .build())
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.WINGS)
                        .addModelLocation(VehicleModels.SPORTS_PLANE_WINGS.getModelLocation())
                        .setOffset(0, 20, -7)
                        .build())
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.SEAT)
                        .addModelLocation(VehicleModels.SPORTS_PLANE_SEAT.getModelLocation())
                        .setOffset(0, 8, 0)
                        .build())
