...
public class MessageFuelVehicle
{
    ...
    public static void encode(MessageFuelVehicle message, FriendlyByteBuf buffer)
    {
        buffer.writeInt(message.entityId);
        buffer.writeEnum(message.hand);
    }

    public static MessageFuelVehicle decode(FriendlyByteBuf buffer)
    {
        return new MessageFuelVehicle(buffer.readInt(), buffer.readEnum(InteractionHand.class));
    }

    public static void handle(MessageFuelVehicle message, Supplier<NetworkEvent.Context> supplier)
    {
