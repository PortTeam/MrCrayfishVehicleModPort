 ...
 * Author: MrCrayfish
 */
public class MessageInteractCosmetic
{
    ...
    public static void encode(MessageInteractCosmetic message, FriendlyByteBuf buffer)
    {
        buffer.writeInt(message.entityId);
        buffer.writeResourceLocation(message.cosmeticId);
    }

    public static MessageInteractCosmetic decode(FriendlyByteBuf buffer)
    {
        return new MessageInteractCosmetic(buffer.readInt(), buffer.readResourceLocation());
    }

    @SuppressWarnings("ConstantConditions")
    public static void handle(MessageInteractCosmetic message, Supplier<NetworkEvent.Context> supplier)
    {
