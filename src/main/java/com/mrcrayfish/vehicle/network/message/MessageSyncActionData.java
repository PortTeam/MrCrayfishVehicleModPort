 ...
 * Author: MrCrayfish
 */
public class MessageSyncActionData
{
    ...
    public static void encode(MessageSyncActionData message, FriendlyByteBuf buffer)
    {
    ...
    public static MessageSyncActionData decode(FriendlyByteBuf buffer)
    {
    ...
    public static void handle(MessageSyncActionData message, Supplier<NetworkEvent.Context> supplier)
    {
