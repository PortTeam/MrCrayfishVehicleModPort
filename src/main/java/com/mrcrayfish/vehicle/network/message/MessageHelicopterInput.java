...
public class MessageHelicopterInput
{
	private float lift;
	...
	public static void encode(MessageHelicopterInput message, FriendlyByteBuf buffer)
	{
	...
	public static MessageHelicopterInput decode(FriendlyByteBuf buffer)
	{
		return new MessageHelicopterInput(buffer.readFloat(), buffer.readFloat(), buffer.readFloat());
	}

	public static void handle(MessageHelicopterInput message, Supplier<NetworkEvent.Context> supplier)
	{
