 ...
 * {@link Item.Properties#setNoRepair()} ()} (Supplier)}, the location of the render call is
...
public class RenderItemEvent extends Event
{
    ...
    public RenderItemEvent(ItemStack heldItem, ItemDisplayContext transformType, PoseStack poseStack, MultiBufferSource source, int light, int overlay, float deltaTicks)
    {
    ...
    public static class Held extends RenderItemEvent
    {
        ...
        public Held(LivingEntity entity, ItemStack heldItem, ItemDisplayContext transformType, PoseStack poseStack, MultiBufferSource source, HumanoidArm arm, int light, int overlay, float deltaTicks)
        {
        ...
        {
            public Pre(LivingEntity entity, ItemStack heldItem, ItemDisplayContext transformType, PoseStack poseStack, MultiBufferSource source, HumanoidArm HumanoidArm, int light, int overlay, float deltaTicks)
            {
        ...
        {
            public Post(LivingEntity entity, ItemStack heldItem, ItemDisplayContext transformType, PoseStack poseStack, MultiBufferSource source, HumanoidArm HumanoidArm, int light, int overlay, float deltaTicks)
            {
                super(entity, heldItem, transformType, poseStack, source, HumanoidArm, light, overlay, deltaTicks);
            }
    ...
    public static class Entity extends RenderItemEvent
    {
        ...
        {
            super(heldItem, ItemDisplayContext.GROUND, poseStack, source, light, overlay, deltaTicks);
            this.entity = entity;
        }
    ...
    public static class Gui extends RenderItemEvent
    {
        ...
        {
            super(heldItem, ItemDisplayContext.GUI, poseStack, source, light, overlay, Minecraft.getInstance().getDeltaFrameTime());
        }
    ...
    public static class ItemFrame extends RenderItemEvent
    {
        ...
        {
            super(heldItem, ItemDisplayContext.FIXED, poseStack, source, light, overlay, deltaTicks);
            this.entity = entity;
        }
