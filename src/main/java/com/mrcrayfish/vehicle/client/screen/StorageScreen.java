...
public class StorageScreen extends AbstractContainerScreen<StorageContainer>
{
    ...
    {
        //this.minecraft.font.drawInBatch(matrixStack, this.getTitle().getString(), 8, 6, 4210752);
        //this.minecraft.font.drawInBatch(matrixStack, this.playerInventory.getDisplayName().getString(), 8, this.imageHeight - 96 + 2, 4210752);
    }
