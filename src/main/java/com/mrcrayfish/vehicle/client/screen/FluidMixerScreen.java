...
public class FluidMixerScreen extends AbstractContainerScreen<FluidMixerContainer>
{
    ...
    protected void renderBg(GuiGraphics matrixStack, float partialTicks, int mouseX, int mouseY)
    {
        ...
        if(this.fluidMixerTileEntity.canMix())
        {
            ...
            int left = startX + 51;
            int top = startY + 27;
            RenderUtil.drawGradientRectHorizontal(poseStack,left, top, (int) (left + 12 * percentageHorizontal), top + 8, blazeColor, blazeColor);
            top += 36;
            RenderUtil.drawGradientRectHorizontal(poseStack,left, top, (int) (left + 12 * percentageHorizontal), top + 8, sapColor, sapColor);
            ...
            if (extractionPercentage >= percentageStart)
            {
                ...
                RenderUtil.drawGradientRectHorizontal(poseStack,left, top, left + 10, top + 10, colorFade, colorFade);
            ...
            if (extractionPercentage >= percentageStart)
            {
                ...
                RenderUtil.drawGradientRectHorizontal(poseStack,left, top, left + 8, (int) (top + 8 * percentageVerticle), blazeColor, blazeColor);
                top += 26;
                RenderUtil.drawGradientRectHorizontal(poseStack,left, (int) (top - 8 * percentageVerticle), left + 8, top, sapColor, sapColor);
            }
            ...
            if (extractionPercentage >= percentageStart)
            {
                ...
                RenderUtil.drawGradientRectHorizontal(poseStack,left, top, right, bottom, statrColor, fluidColor);
