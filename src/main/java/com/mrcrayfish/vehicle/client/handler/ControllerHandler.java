...
{
    public static final IBindingContext VEHICLE_KEY_CONFLICT = (IBindingContext) new VehicleKeyConflict();
    ...
    public static final IBindingContext AIR_VEHICLE_KEY_CONFLICT = (IBindingContext) new VehicleKeyConflict();
...
//    @SubscribeEvent
//    public void onButtonInput(ControllerEvents.Input event)
//    {
...
//    }
    ...
    @SubscribeEvent
    public void onRenderPlayerPreview(RenderPlayerEvent event)
    {
    ...
    public static class VehicleKeyConflict implements IBindingContext
    {
        @Override
