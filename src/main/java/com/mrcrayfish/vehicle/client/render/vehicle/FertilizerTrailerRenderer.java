...
public class FertilizerTrailerRenderer extends AbstractTrailerRenderer<FertilizerTrailerEntity>
{
    ...
    protected void render(@Nullable FertilizerTrailerEntity vehicle, PoseStack matrixStack, MultiBufferSource renderTypeBuffer, float partialTicks, int light)
    {
                ...
                if(!stack.isEmpty())
                {
                    ...
                    for(int j = 0; j < count; j++)
                    {
                        matrixStack.pushPose();
                        {
                            ...
                            matrixStack.mulPose(com.mojang.math.Axis.XP.rotationDegrees(90F));
                            matrixStack.mulPose(com.mojang.math.Axis.ZP.rotationDegrees(47F * index));
                            matrixStack.mulPose(com.mojang.math.Axis.XP.rotationDegrees(2F * layerIndex));
        ...
        matrixStack.pushPose();
        {
            ...
            matrixStack.mulPose(com.mojang.math.Axis.ZP.rotationDegrees(90F));
