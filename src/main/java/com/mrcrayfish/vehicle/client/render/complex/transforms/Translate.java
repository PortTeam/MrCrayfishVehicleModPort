...
public class Translate implements Transform
{
    ...
    public Matrix4f create(VehicleEntity entity, float partialTicks)
    {
        ...
        return matrix4f.translate((float) this.x.getValue(entity, partialTicks) * 0.0625F, (float) this.y.getValue(entity, partialTicks) * 0.0625F, (float) this.z.getValue(entity, partialTicks) * 0.0625F);
    }
