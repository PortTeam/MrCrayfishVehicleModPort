 ...
 * Author: MrCrayfish
 */
public class TyreSmokeParticle extends TextureSheetParticle
{
    public TyreSmokeParticle(ClientLevel world, double x, double y, double z, double xd, double yd, double zd)
    {
        super(world, x, y, z);
