...
public abstract class PlaneEntity extends PoweredVehicleEntity
{
    ...
    public void updateVehicleMotion()
    {
        ...
        Vector3f elevatorDirection = new Vector3f((Vector3fc) Vec3.directionFromRotation(this.elevatorAngle * elevatorForce * this.getElevatorSensitivity(), 0));
    ...
    public void onClientUpdate()
    {
        ...
        if(entity instanceof Player && ((Player) entity).isLocalPlayer())
        {
            ...
            PacketHandler.getChannel().sendToServer(new MessagePlaneInput(this.lift.getLocalValue(), entity.zza, entity.xxa));
        }
    }
