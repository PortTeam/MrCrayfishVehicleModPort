...
public class SeederTrailerEntity extends TrailerEntity implements IStorage
{
    ...
    public void tick()
    {
        ...
        if(!this.level.isClientSide && Config.SERVER.trailerInventorySyncCooldown.get() > 0 && inventoryTimer++ == Config.SERVER.trailerInventorySyncCooldown.get())
        {
            ...
            PacketHandler.getChannel().send(PacketDistributor.TRACKING_ENTITY.with(() -> SeederTrailerEntity.this), new MessageSyncStorage(this, INVENTORY_STORAGE_KEY));
        }
    }
    ...
    {
        BlockPos pos = new BlockPos((int) (xo + vec.x), (int) (yo + 0.25), (int) (zo + vec.z));
