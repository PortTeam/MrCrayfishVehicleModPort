...
{
    protected FluidTank tank = new FluidTank(100)
    {
        @Override
    ...
    public void syncTank()
    {
        ...
        {
            PacketHandler.getChannel().send(PacketDistributor.TRACKING_ENTITY.with(() -> this), new MessageEntityFluid(this.getId(), this.tank.getFluid()));
        }
    }
