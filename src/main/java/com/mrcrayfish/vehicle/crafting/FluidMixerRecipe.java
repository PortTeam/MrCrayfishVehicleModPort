...
public class FluidMixerRecipe implements Recipe<FluidMixerTileEntity>
{
    ...
    public int hashCode()
    {
        if(this.hashCode == 0)
        {
            this.hashCode = Objects.hash(this.inputs[0].getFluid().toString(), this.inputs[1].getFluid().toString(), this.ingredient.getItem().toString());
        }
    ...
    @Override
    public ItemStack assemble(FluidMixerTileEntity fluidMixerTileEntity, RegistryAccess registryAccess) {
