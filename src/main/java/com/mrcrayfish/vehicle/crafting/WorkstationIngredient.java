...
public class WorkstationIngredient extends Ingredient
{
    ...
    protected WorkstationIngredient(Stream<? extends ItemValue> itemList, int count)
    {
        super(itemList);
        this.itemList = null;
        this.count = count;
    ...
    {
        Ingredient.ItemValue value = (ItemValue) valueFromJson(object);
    ...
    public static WorkstationIngredient of(Item provider, int count)
    {
    ...
    {
        return new WorkstationIngredient((Stream<? extends ItemValue>) new TagValue(tag), count);
    }

    public static WorkstationIngredient of(ResourceLocation id, int count)
    {
        return new WorkstationIngredient((Stream<? extends ItemValue>) new MissingSingleItemList(id), count);
    }
     ...
     * to be read by the regular {@link net.minecraft.world.item.crafting.Ingredient.ItemValue}. Only use this for generating data.
     */
